...
public class EmployeeToEmployeeMessage : IMessage
{
    public EmployeeToEmployeeMessage(EmployeeAccount source, EmployeeAccount employee, string messageText, IMessage.MessageType type)
    {
    ...
    public EmployeeAccount Receiver { get; private set; }
