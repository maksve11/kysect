...
public class MessageManagerGE : IMessageManager<GuestAccount, EmployeeAccount>
{
    private readonly List<EmployeeAccount> _employees;
    private readonly List<GuestAccount> _guests;
    private readonly List<IMessage> _messages;

    public MessageManagerGE(ILogger logger)
    {
    ...
    public IMessage SendMessage(string message, GuestAccount sender, EmployeeAccount receiver)
    {
        ...
        var newMessage =
            new GuestToEmployeeMessage(sender, receiver, message, IMessage.MessageType.Open);
